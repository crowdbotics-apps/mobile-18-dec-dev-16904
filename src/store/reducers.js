...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HGFJGJH_LIST:
    case types.API_V1_HGFJGJH_LIST_SUCCEEDED:
    case types.API_V1_HGFJGJH_LIST_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_HGFJGJH_CREATE:
    case types.API_V1_HGFJGJH_CREATE_SUCCEEDED:
    case types.API_V1_HGFJGJH_CREATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_HGFJGJH_READ:
    case types.API_V1_HGFJGJH_READ_SUCCEEDED:
    case types.API_V1_HGFJGJH_READ_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_HGFJGJH_UPDATE:
    case types.API_V1_HGFJGJH_UPDATE_SUCCEEDED:
    case types.API_V1_HGFJGJH_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_HGFJGJH_PARTIAL_UPDATE:
    case types.API_V1_HGFJGJH_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HGFJGJH_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
    case types.API_V1_HGFJGJH_DELETE:
    case types.API_V1_HGFJGJH_DELETE_SUCCEEDED:
    case types.API_V1_HGFJGJH_DELETE_FAILED:
      return Object.assign({}, state, {
        mobiledecAPI: [...state.mobiledecAPI, action.response]
      })
